...
class db_output_stats:
    ...
    def __init__(self):  
        ...
        self.connection=''
        self.cursor=''
        self.fieldnames=["title","year","Show_type","Source","Subscription","content_type","Added_to_site","Updated_at_DB"]
    ...
    def main(self):
        ...
        result_sheet='/operation/attachments/recently_added_content_amazon_%s.csv'%(datetime.now().strftime('%b %d, %Y'))
        ...
        with output_file as outputcsvfile:
            ...
            query="select title,year,Show_type,Source,Service,content_type,Added_to_site,Updated_at_DB from {table_name} where Added_to_site='%s'".format(table_name=db_detail.table)
