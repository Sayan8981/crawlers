...
class WhatsNewNetflixCrawlerPipeline(object):
   ...
   def process_item(self, item, spider):
        self.query="insert into {table_name} (netflix_id,title,image,rating,url,content_type,show_type,season_number,year,tv_rating,description,genre,cast,director,duration,language,Awards,updated_db,item_category) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)".format(table_name=db_detail.table)
