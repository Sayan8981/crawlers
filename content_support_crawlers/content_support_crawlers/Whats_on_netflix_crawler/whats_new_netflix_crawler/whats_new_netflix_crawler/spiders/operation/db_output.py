...
class db_output_stats:
    ...
    def main(self):
        ...
        with output_file as outputcsvfile:
            ...
            query="select netflix_id,title,image,rating,url,content_type,show_type,season_number,year,tv_rating,description,genre,cast,director,duration,language,Awards,updated_db,item_category from {table_name} where updated_db='%s'".format(table_name=db_detail.table)
