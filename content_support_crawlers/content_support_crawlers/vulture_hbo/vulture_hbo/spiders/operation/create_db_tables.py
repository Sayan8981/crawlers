...
class createdbtable:
    ...
    def __init__(self):
        ...
        self.connection=''
        self.cursor=''
        self.create_tables=["CREATE TABLE %s (title varchar(1000) NOT NULL,year varchar(254) DEFAULT NULL,content_category varchar(100) DEFAULT NULL,content_available varchar(255),content_defination varchar(1500) DEFAULT NULL, updated_db varchar(254) DEFAULT NULL,Service varchar(254) DEFAULT NULL, PRIMARY KEY (title)) ENGINE=InnoDB DEFAULT CHARSET=utf8"%db_detail.table]
