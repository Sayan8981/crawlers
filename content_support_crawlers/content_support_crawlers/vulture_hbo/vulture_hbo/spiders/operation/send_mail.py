...
class send_emails:
    ...
    def main(self):
        ...
        message["Subject"]="Vulture HBO result on %s"%(datetime.datetime.now().strftime('%b %d, %Y'))
        ...
        filenames=['hbo_added_content_%s.csv'%(datetime.datetime.now().strftime('%b %d, %Y'))]
