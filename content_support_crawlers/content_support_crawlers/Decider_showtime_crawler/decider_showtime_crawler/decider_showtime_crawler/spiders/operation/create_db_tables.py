...
class createdbtable:
    ...
    def __init__(self):
        ...
        self.connection=''
        self.cursor=''
        self.create_tables=["CREATE TABLE {table_name} (title varchar(1000) NOT NULL,category varchar(1500) DEFAULT NULL,released varchar(100) DEFAULT NULL,content_defination varchar(1500),updated_db varchar(254) DEFAULT NULL,Service varchar(254) DEFAULT NULL,ET_PT_timing varchar(1000) DEFAULT NULL,PRIMARY KEY(title)) ENGINE=InnoDB DEFAULT CHARSET=utf8".format(table_name=db_detail.table)]
