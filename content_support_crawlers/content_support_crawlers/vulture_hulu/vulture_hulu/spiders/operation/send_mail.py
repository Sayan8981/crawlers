...
class send_emails:
    ...
    def user_input(self):
        self.sender_email="venkatesh@headrun.com"
        self.receiver_email=["saayan@headrun.com","jyoshna@headrun.com"]
        self.password="10369.venky"

    def user_message(self):
        text="""Hi Team,

        
    Titles from Vulture Hulu site.
    ...
    def main(self):
        ...
        message["Subject"]="Vulture Hulu Result on %s"%(datetime.datetime.now().strftime('%b %d, %Y'))
        ...
        filenames=['hulu_added_content_%s.csv'%(datetime.datetime.now().strftime('%b %d, %Y'))]
