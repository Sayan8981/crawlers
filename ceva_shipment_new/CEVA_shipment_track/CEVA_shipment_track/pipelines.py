...
class CevaShipmentTrackPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        self.cursor.execute(self.query,(item["waybill_number"],item["ship_date"],item["due_date"],
            item["estimated_delivery_date"],item["shipper_location"],item["consignee_location"],item["total_pcs"]
            ,item["actual_weight"],item["charge_weight"],item["freight_terms"],item["service_level"]
            ,item["delivery_type"],item["movement_type"],str(item["history_data"])))
        self.counter+=1
